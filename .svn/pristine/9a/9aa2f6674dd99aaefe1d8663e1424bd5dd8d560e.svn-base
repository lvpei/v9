...
public:
	...
	*/
	...
	// by Huansen
	// to get the i-th column of the matrix directly
	Vector3d Matrix::getColumn(int index = 0);

	/************************************************************************/
	/* Find the min and max value in the matrix  added by lvp 11-4-30       */
	/************************************************************************/
	void findMinMax(double* min_out, double* max_out);

	/***************************************************************************/
	/* Find the index of min and max value in the matrix  added by lvp 11-4-30 */
	/***************************************************************************/
	void findMinMax(int imin_out, int jmin_out, int imax_out, int jmax_out);
};
