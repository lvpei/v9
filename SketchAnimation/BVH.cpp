...
{
	// not to draw these following joints
	if(joint == NULL || 
		strcmp(joint->name.c_str(),"lwrist") == 0 || strcmp(joint->name.c_str(),"rwrist") ==0 ||
		strcmp(joint->name.c_str(),"lfoot") == 0 || strcmp(joint->name.c_str(),"rfoot") == 0 ||
		strcmp(joint->name.c_str(),"upperneck") == 0 )
		return;
