...
public:
	...
	*/
	...
	void setToRotationMatrixFromVectors(Vector3d from,Vector3d to);

	void setTransformationMatrixFromPoints(const Point3d &from1,const Point3d &from2,const Point3d &to1,const Point3d &to2);

	// added by lvp 2012-2-9
	/**
		Rotate a Vector3d by a 4x4 matrix - vector3d multiplication. Result and v need to be different!!
	*/
